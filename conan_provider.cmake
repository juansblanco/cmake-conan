...
function(detect_arch ARCH)
    ...
    elseif(CMAKE_SYSTEM_NAME MATCHES "Windows")
        set(host_arch ${CMAKE_VS_PLATFORM_NAME})
    else()
        set(host_arch ${CMAKE_SYSTEM_PROCESSOR})
    endif()
    if(host_arch MATCHES "aarch64|arm64|ARM64")
        set(_ARCH armv8)
    elseif(host_arch MATCHES "armv7|armv7-a|armv7l|ARM")
        set(_ARCH armv7)
    elseif(host_arch MATCHES armv7s)
        set(_ARCH armv7s)
    elseif(host_arch MATCHES "i686|i386|Win32")
        set(_ARCH x86)
    elseif(host_arch MATCHES "amd64|x86_64|x64|AMD64")
        set(_ARCH x86_64)
    endif()
