...
function(detect_arch ARCH)
    ...
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|ARM64|arm64" OR CMAKE_OSX_ARCHITECTURES MATCHES arm64 OR CMAKE_GENERATOR_PLATFORM STREQUAL ARM64)
        set(_ARCH armv8)
    elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "armv7-a|armv7l" OR CMAKE_OSX_ARCHITECTURES MATCHES armv7 OR CMAKE_GENERATOR_PLATFORM STREQUAL ARM)
        set(_ARCH armv7)
    elseif(CMAKE_OSX_ARCHITECTURES MATCHES armv7s)
        set(_ARCH armv7s)
    elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "i686" OR CMAKE_OSX_ARCHITECTURES MATCHES i386 OR CMAKE_GENERATOR_PLATFORM STREQUAL Win32)
        set(_ARCH x86)
    elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "AMD64|amd64|x86_64" OR CMAKE_OSX_ARCHITECTURES MATCHES x86_64 OR CMAKE_GENERATOR_PLATFORM STREQUAL x64)
        set(_ARCH x86_64)
    endif()
